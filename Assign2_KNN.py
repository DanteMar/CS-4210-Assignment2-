...
# FILENAME: Assign2_KNN.py
# SPECIFICATION: Find the LOO-CV error rate of a 1NN test with given data
...
#--> add your Python code here
print('LOO-CV Error rate for 1NN:', errorCounter/len(db))
